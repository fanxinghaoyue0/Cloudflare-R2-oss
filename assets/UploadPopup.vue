    ...
    <Transition name="slide-up">
      <div v-if="modelValue" class="popup-content">
        <div class="button-grid">
          <button type="button" @click="triggerInput('camera-upload')">
          ...
          <button type="button" @click="triggerInput('media-upload')">
          ...
          <button type="button" @click="triggerInput('file-upload')">
